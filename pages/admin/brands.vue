<template>
  <div class="h-screen bg-slate-100 overflow-y-auto p-8 pt-[80px]">
    <div class="flex justify-between">
      <div class="flex flex-row text-[#4fc520] items-center gap gap-2">
    ...
    <div class="p-8 flex flex-row justify-evenly">
      ...
      <div class="flex flex-col gap gap-3">
        <label for="status" class="block mt-4 w-[450px] text-[#4fc520] text-[20px] font-inter">Status:</label>
          ...
          <tr v-for="(brand, index) in brands" :key="index">
            ...
            <td class="p-4">
              <button
                ...
                class="text-white py-2 px-4 rounded-sm hover:bg-green-600 duration-300 bg-[#4fc520] font-medium"
              >
                Edit
              </button>
              <button
    ...
    <div v-if="showModal" class="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
      <div class="bg-white p-8 rounded-lg shadow-lg w-[500px]">
        <h3 class="font-inter text-[#4fc520] text-2xl mb-4">Edit Brand</h3>
